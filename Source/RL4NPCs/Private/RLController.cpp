...
void ARLController::OnPerceptionUpdated(TArray<AActor*> UpdatedActors)
{
	...
	{
		if (Actor->IsA<ARLCharacter>() && !GetSeeingPawn())
		{
...
void ARLController::Possess(APawn* InPawn)
{
...
AActor* ARLController::GetSeeingPawn()
{
